...
| `rating`             | The rating given to the recipe by users (on a scale).                                                     | Extracted from the interactions dataset and replaced `0` values with `NaN`.                                                               |
| `review`             | The text of user reviews for the recipe.                                                                  | Directly from the interactions dataset.                                                                                                   |
| `steps_per_ingredient`| The average number of steps per ingredient in the recipe.                                                 | Computed as `n_steps / (n_ingredients + 1e-6)` to avoid division by zero.                                                                 |
| `avg rating`         | The average rating for the recipe.                                                                         | Aggregated from the interactions dataset by calculating the mean rating for each recipe.                                                  |
...
<iframe src="assets/interesting_aggregates.html" width="800" height="600"></iframe>
...
<iframe src="assets/proteindistributionsdiff.html" width="800" height="600"></iframe>

<iframe src="assets/protein_missingness.html" width="800" height="600"></iframe>
